...
[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-yaml/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-yaml/actions/workflows/validate.yml)

Neovim tree-sitter queries for **yaml**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-yaml",
...
- [ ] Changes are scoped to `yaml` — do not include files for other languages
